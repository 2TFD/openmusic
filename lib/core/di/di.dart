...
import 'package:openmusic/layers/data/datasources/local/embeding_task/drift/embedding_task_drift_local_source.dart';
...
Future<void> configureDependencies({required String appDir}) async {
  ...
  getIt.registerLazySingleton(
    () => TrackSourceResolver([SoundcloudTrackSource(), YoutubeTrackSource()]),
  );
  getIt.registerLazySingleton(
    () => EmbeddingWorker(
